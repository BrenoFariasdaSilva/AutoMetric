...
```bash
make auto_metric_script args="--repo_urls https://github.com/username/repository1 https://gitlab.com/username/repository2 --githubToken YOUR_GITHUB_TOKEN --finish_sound"
```
...
```bash
python3 ./AutoMetric.py --repo_urls "https://github.com/username/repository1" "https://gitlab.com/username/repository2" --githubToken YOUR_GITHUB_TOKEN --finish_sound
```
